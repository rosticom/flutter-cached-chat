...
import 'package:dartchat/view/widgets/button_widget.dart';
import 'package:dartchat/view/widgets/input_field.dart';
...
class _SignInFormState extends State<SignInForm>
  ...
  void _onSubmit() async {
    ...
    if (_formKey.currentState.validate()) {
      BlocProvider.of<AccountBloc>(context).add(SigninEvent(email: email, password: password));
    }
  }
